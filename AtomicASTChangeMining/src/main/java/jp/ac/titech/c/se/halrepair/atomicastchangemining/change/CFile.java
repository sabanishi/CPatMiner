...
public class CFile extends ChangeEntity {
    ...
    private final RevisionAnalyzer cRevisionAnalyzer;
    private final String path;
    private final String simpleName;
    private final HashSet<CClass> classes = new HashSet<CClass>();
    ...
    public CFile(RevisionAnalyzer revisionAnalyzer, String filePath, String content) {
        ...
        if (compileUnit == null || compileUnit.types() == null || compileUnit.types().isEmpty()) {
            ...
            for (int index = 0; index < compileUnit.types().size(); index++) {
                AbstractTypeDeclaration declaration = (AbstractTypeDeclaration) compileUnit.types().get(index);
