...
public class CField extends ChangeEntity {
    ...
    private final static double THRESHOLD_SIMILARITY = 0.75;

    private final CClass cClass;
    private final int modifiers;
    private final HashSet<String> sModifiers = new HashSet<String>();
    private final String name;
    private final String type;
    private final Expression initializer;
    private final HashSet<String> literals = new HashSet<String>();
    ...
    public CField(CClass cClass, FieldDeclaration field, String type, VariableDeclarationFragment fragment) {
        ...
        if (initializer != null) {
            this.vector = new HashMap<Integer, Integer>(
                    (HashMap<Integer, Integer>) initializer.getProperty(VectorVisitor.propertyVector));
    ...
    public static void map(HashSet<CField> fieldsM, HashSet<CField> fieldsN, HashSet<CField> mappedFieldsM, HashSet<CField> mappedFieldsN) {
        ...
        for (CField cfM : fieldsM) {
            ...
            for (CField cfN : fieldsN) {
                ...
                if (sim[0] >= THRESHOLD_SIMILARITY && sim[1] >= THRESHOLD_SIMILARITY) {
    ...
    public static double[] mapAll(HashSet<CField> fieldsM,
                                  HashSet<CField> fieldsN,
                                  HashSet<CField> mappedFieldsM,
